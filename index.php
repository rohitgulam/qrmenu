...
?>
        <div class="dashboard-container">
            ...
            <div class="qr-group">
                ...
                <a href=<?php echo '/public/main.php?rest_id='.$_SESSION["userid"] ?> ><img src='<?php echo generateQR( '/public/main.php?rest_id='.$_SESSION["userid"]) ?>' alt='QR Code' width='200' height='200'></a>
            </div>
<?php 
    include "footer.php"
?>