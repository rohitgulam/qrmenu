...
?>
        <div class="qr-group">
            <div class="qr-group-inner">
                <a href=<?php echo '../public/main.php?rest_id='.$_SESSION["userid"] ?> ><img src='<?php echo generateQR( '../public/main.php?rest_id='.$_SESSION["userid"]) ?>' alt='QR Code' width='220' height='220'></a>
